    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col `}>
        <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full `}>
            <div className="flex-[1] flex flex-col justify-start mr-10 ml-4">
                <h1 className=" text-#af9a7d text-3xl font-extrabold font-poppins">Your Place</h1>
                <p className={`${styles.paragraph} mt-2 max-w-[312px] text-slate-600`} style={{ display: 'flex', alignItems: 'center' }}>
                    <MdEmail size={23} /> <span style={{ marginLeft: '10px' }}>yourplace@gmail.com</span>
                </p>
                ...
                <p className={`${styles.paragraph} mt-2 max-w-[312px] text-slate-600`} style={{ display: 'flex', alignItems: 'center' }}>
                    <MdLocationOn size={80} /> <span style={{ marginLeft: '10px' }}> @Your Place is part of Booking Holdings Inc., the world leader in online travel & related services.</span>
                </p>
        ...
        <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
            <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-slate-600 ml-4">
                Copyright Ⓒ 2023 Your Place.com. All Rights Reserved.
            </p>
